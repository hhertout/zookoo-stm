...
The targets definition supports a specific schema you should follow. This schema is available in the targets schema documentation.

## Discribe in the config file
...
The targets can also be loaded from a JSON file. The file should contain an array of target objects with the same structure as defined above.
